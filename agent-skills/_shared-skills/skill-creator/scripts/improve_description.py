...
using the configured model with extended thinking.
"""
...
def improve_description(
    ...
    prompt = f"""You are optimizing a skill description for a coding-agent skill called "{skill_name}". A "skill" is like a prompt with progressive disclosure -- there's a title and description that the agent sees when deciding whether to use the skill, and then if it does use the skill, it reads the .md file which has lots more details and potentially links to other resources in the skill folder like helper files and scripts and additional documentation or examples.
